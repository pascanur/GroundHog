...
class Encoder(EncoderDecoderBase):
    ...
    def __init__(self, state, rng, approx_embedder):
        self.state = state
        self.rng = rng
        self.approx_embedder = approx_embedder
