...
class Classif_Model(Model):
    def  __init__(self,
        ...
        """
        super(Classif_Model, self).__init__(output_layer=cost_layer,
                                       sample_fn=None,
                                       indx_word=None,
                                       indx_word_src=None,
                                       rng=rng)
        ...
        self.need_inputs_for_generating_noise = False
        self.cost_layer = cost_layer
        self.error = self.cost_layer.error
